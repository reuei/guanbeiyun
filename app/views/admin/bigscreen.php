  ...
  <div class="bs-grid" style="margin-bottom:16px;">
    ...
    <div class="bs-panel">
      ...
      <div style="display:flex;flex-direction:column;gap:12px;margin-top:14px;">
        ...
        <div style="display:flex;justify-content:space-between;align-items:center;"><span style="color:#8b949e;font-size:13px;">系统版本</span><span style="color:#5b8def;font-size:13px;">v1.0.0</span></div>
