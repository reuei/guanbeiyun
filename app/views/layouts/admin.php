...
<div class="admin-layout">
  ...
  <aside class="admin-sidebar" id="adminSidebar">
    ...
    <nav class="sidebar-menu">
      ...
      <!-- 系统配置 -->
      <div class="menu-group">
        <div class="menu-item has-sub <?php echo $activeMenu==='system'?'active':'' ?> <?php echo in_array($activeSub,['siteconfig','announcement','articles','mail','oauth','maintenance','captcha'])?'expanded':'' ?>">
        ...
        <div class="menu-sub <?php echo in_array($activeSub,['siteconfig','announcement','articles','mail','oauth','maintenance','captcha'])?'open':'' ?>">
          ...
          <a class="menu-item <?php echo $activeSub==='captcha'?'active':'' ?>" href="<?php echo site_url('admin/captcha'); ?>">
            <svg style="width:14px;height:14px;flex-shrink:0;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><path d="M9 12l2 2 4-4"/></svg>
            人机验证配置
          </a>
        </div>
      </div>
