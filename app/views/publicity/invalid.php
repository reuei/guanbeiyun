<?php /** 失效网站公示页 */ $rows = $rows ?? []; ?>
<section class="section">
  <div class="container">
    <div class="section-title" style="margin-bottom:24px;">
      <h1>失效网站公示</h1>
      <p>本页公示已失效或违规的备案网站，包含备案号、失效原因及备案用户等信息。</p>
    </div>
            ...
            <table class="table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><span class="badge badge-info">失效网站</span></td>
                  <td class="text-sm"><?php echo !empty($r['reason']) ? e($r['reason']) : '<span class="text-muted">-</span>'; ?></td>
                  <td><span class="badge badge-danger">已失效</span></td>
                  <td class="text-sm">
