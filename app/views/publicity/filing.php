            ...
            <table class="table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><button class="btn btn-ghost btn-sm" onclick='showPubDetail(<?php echo json_encode(["type"=>"备案公示","icp_no"=>$r["icp_no"]?:"","title"=>$r["title"]?:"","content"=>$r["content"]?:"","link"=>$r["link"]?:"","reason"=>$r["reason"]?:"","username"=>$r["username"]?:"匿名","created_at"=>$r["created_at"]?:""], JSON_UNESCAPED_UNICODE|JSON_UNESCAPED_SLASHES); ?>)'>详情</button></td>
                </tr>
                <?php endforeach; ?>
              </tbody>
            </table>
...
<div class="modal-overlay" id="pubDetailModal" onclick="if(event.target===this)gbModal.close('pubDetailModal')">
  <div class="modal-box" style="max-width:520px;">
    <div class="modal-head"><h3 id="pdTitle">公示详情</h3><span class="icon-btn" onclick="gbModal.close('pubDetailModal')"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg></span></div>
...
function showPubDetail(d){
  var html='<div class="detail-list">'+
    ...
    (d.reason?'<div class="dl-item"><div class="dl-label">原因</div><div class="dl-value">'+d.reason+'</div></div>':'')+
